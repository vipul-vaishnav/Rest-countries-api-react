...
const Filter = () => {
  return (
    <div>
      ...
      <div className="my-12 mb-0 rounded-md shadow-lg w-fit bg-element_color">
        <button className="flex w-full h-full px-12 py-5 text-base font-semibold gap-28 text-text_color">
